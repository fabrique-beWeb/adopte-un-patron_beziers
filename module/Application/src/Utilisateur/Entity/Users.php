...
class Users
{
     ...
     * @var string
     *
     * @ORM\Column(name="telephone", type="string", length=16, precision=0, scale=0, nullable=false, unique=false)
     */
    private $telephone;
     ...
     * @var integer
     *
     * @ORM\Column(name="code_postal", type="smallint", precision=0, scale=0, nullable=false, unique=false)
     */
    private $codePostal;
     ...
     * @var integer
     *
     * @ORM\Column(name="date_naissance", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="accroche", type="text", length=65535, precision=0, scale=0, nullable=true, unique=false)
     */
    private $accroche;
     ...
     * @var integer
     *
     * @ORM\Column(name="visites", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
    private $visites;
     ...
     * @var integer
     *
     * @ORM\Column(name="inscription", type="integer", precision=0, scale=0, nullable=false, unique=false)
     */
    private $inscription;
