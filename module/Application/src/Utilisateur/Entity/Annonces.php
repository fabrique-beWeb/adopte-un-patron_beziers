...
class Annonces
{
     ...
     * @var integer
     *
     * @ORM\Column(name="salaire", type="smallint", precision=0, scale=0, nullable=false, unique=false)
     */
    private $salaire;
     ...
     * @var integer
     *
     * @ORM\Column(name="duree", type="smallint", precision=0, scale=0, nullable=false, unique=false)
     */
    private $duree;
     ...
     * @var integer
     *
     * @ORM\Column(name="experience", type="smallint", precision=0, scale=0, nullable=false, unique=false)
     */
    private $experience;
     ...
     * @var string
     *
     * @ORM\Column(name="statut", type="string", length=255, precision=0, scale=0, nullable=false, unique=false)
     */
    private $statut;
     ...
     * @var string
     *
     * @ORM\Column(name="presentation", type="text", length=65535, precision=0, scale=0, nullable=true, unique=false)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="grade", type="string", length=255, precision=0, scale=0, nullable=true, unique=false)
     */
    private $grade;
